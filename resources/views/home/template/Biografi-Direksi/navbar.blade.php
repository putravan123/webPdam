            ...
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu m-0">
                        ...
                        <a href="" class="dropdown-item">Core Values</a>
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        ...
                        <a href="" class="dropdown-item">Info Register</a>
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            ...
            <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                ...
                <li class="breadcrumb-item"><a href="">Tentang Pdam</a></li>
                <li class="breadcrumb-item"><a href="{{ route('struktur') }}">Struktur Organisasi</a></li>
                <li class="breadcrumb-item"><a href="">Core Values</a></li>
                <li class="breadcrumb-item"><a href="">Peta Wilayah</a></li>
                <li class="breadcrumb-item"><a href="">Kapasitas Produk</a></li>
                <li class="breadcrumb-item"><a href="">Sambunagan Langganan</a></li>
